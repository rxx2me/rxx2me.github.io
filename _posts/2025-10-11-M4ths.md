...
author: Rxx2me
image: /assets/categories/crypto.svg
---
...
<ol>
  <li> Parse given n and ct.</li>
<li> Let A = ceil(sqrt(n)).</li>
<li> Work mod n with f(x) = (A + x)^2 − n. For the correct small x0, f(x0) ≡ 0 (mod n).</li>
<li> Use a lattice/small-root routine to recover x0 with bound ~n^(1/4).</li>
<li> Set a = A + x0, b^2 = a^2 − n; then p = a − b, q = a + b.</li>
<li> Compute φ(n) = (p−1)(q−1), d = e^(-1) mod φ(n).</li>
<li> Decrypt m = ct^d mod n → extract flag.</li>
</ol>
